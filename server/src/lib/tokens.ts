...
export const SENSOR_TOKEN_PREFIX = "pp_sensor_";

export function generateSensorToken(): string {
  return `${SENSOR_TOKEN_PREFIX}${crypto.randomBytes(32).toString("base64url")}`;
}

export function sensorTokenLastFour(token: string): string {
